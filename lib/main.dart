...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _checkAuthToken() async {
    ...
    if (token != null && token.isNotEmpty) {
      // Validate token with backend (optional for now, but crucial for production)
      bool isValidToken = await AuthService.validateToken(token);
      if (isValidToken) {
        setState(() {
          _isLoggedIn = true;
        });
